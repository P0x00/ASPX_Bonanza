...
public static extern IntPtr GetStdHandle(IntPtr handle);
   ...
   static extern bool DuplicateHandle(IntPtr hSourceProcessHandle,
    ...
    bool Login_Attemp = LogonUser("user", "domain", "password", LOGON32_LOGON_INTERACTIVE, LOGON32_PROVIDER_DEFAULT, out DupeToken);
 using (WindowsIdentity newId = new WindowsIdentity(DupeToken))
                {
